			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					<div class="accordionHeader">
						<h2><span>Folder</span>运行维护</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="<%=path%>/reportAction.do?method=toReportframe" target="navTab" rel="main">曲线图</a></li>		
							<li><a href="<%=path%>/reportAction.do?method=toGetReport" target="navTab" rel="main">报表</a></li>	
						</ul>
					</div>
