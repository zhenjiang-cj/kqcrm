...
<div class="pageContent">
  <form class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)" action="<%=path%>/companyAction.do?method=doProPerfSave" method="post" name="proForm">
  <input type="hidden" name="company_info_id" id="company_info_id" value="<%=comForm.getCompany_info_id() %>">
  	...
  	<div class="formBar">
			<ul>
				...
				<dt>万米以上小区：</dt>
					<dd>
						<input type="text" name="wpm_district" maxlength="4"   class="required digits" />个
					</dd>
				</dl>
				<dl>
				<dt>整改小区：</dt>
					<dd>
						<input type="text" name="rectification_district" maxlength="4"  class="required digits" />个
					</dd>
				</dl>
				<dl>
				<dt>总建筑面积：</dt>
					<dd>
						<input type="text" name="full_built_area"  maxlength="16"   class="required digits" />㎡
					</dd>
				</dl>
				...
				<dt>年度企业利润总额：</dt>
					<dd>
						<input type="text" name="full_year_profit" maxlength="10"  class="required digits" /> 元 
					</dd>
				</dl>
