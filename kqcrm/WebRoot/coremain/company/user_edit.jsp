...
<div  id="div_page"  class="pageContent">
  <form class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)" action="<%=path%>/companyAction.do?method=doUserOnEdit" method="post" name="userForm">
    ...
    <h1>企业在职人员</h1>
		...
		<p>
			<label>移动电话：</label>
			<input type="text" name="mobile_phone" id="mobile_phone"  maxlength="11"  value="<%=user.getMobile_phone()==null?"":user.getMobile_phone() %>" class="digits"  />
		</p>
		<p>
			<label>电子邮箱：</label>
	...
	<div class="divider"></div>
		...
		<p>
			<label>职称证号：</label> 
			<input type="text" name="station_card_no" id="station_card_no"   value="<%=user.getStation_card_no()==null?"":user.getStation_card_no() %>"   maxlength="30"  class="alphanumeric"    />
		</p>
		<!-- 
		<p>
			<label>岗位编号：</label>
		...
		<p>
			<label>有效期开始时间：</label>
			<input type="text" name="post_start_date" id="post_start_date"   class="date" readonly="true"  value="<%=user.getPost_start_date()==null?"":user.getPost_start_date() %>"  />
			<a class="inputDateButton" href="javascript:;">选择</a>
		</p>
		<p>
			<label>有效期结束时间：</label>
			<input type="text" name="post_end_date" id="post_end_date"   class="date" readonly="true"   value="<%=user.getPost_end_date()==null?"":user.getPost_end_date() %>"   />
			<a class="inputDateButton" href="javascript:;">选择</a>
		</p>
		 -->
		<p>
