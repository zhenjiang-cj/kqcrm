							...
							if( userList!=null && userList.size()>0  ){
								...
								%>
									<tr target="sid_user" rel="1">
										<td><%=i %></td>
										<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%=user.getEmployee_name() %></td>
										<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%=DictMgmt.getValueDescs(DictMgmt.DICT_COMPANY_USER_STATION,user.getPost(),"" )%>  </td>
										<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%=DictMgmt.getValueDescs(DictMgmt.DICT_COMPANY_USER_EDU,user.getEducation(),"" )%>  </td>
										<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%=DictMgmt.getValueDescs(DictMgmt.DICT_COMPANY_USER_STA_GRADE,user.getStation_grade(),"" )%>  </td>
										<td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><%=DictMgmt.getValueDescs(DictMgmt.DICT_COMPANY_USER_POST,user.getStation(),"" )%>  </td>
									</tr>
								<% 
								}
							}
