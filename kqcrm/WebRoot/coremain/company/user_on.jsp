  ...
  <form id="pagerForm" method="post" action="<%=path%>/companyAction.do?method=viewUseron">
    ...
    <div id="div1" style="width:100%; float:left;margin:0px;">
				...
				if("".equals(comForm.getApply_order_id())){
					%>
									<li><a class="add" href="<%=path%>/companyAction.do?method=toUseronadd" target="navTab"><span>添加</span></a></li>
				...
				if("".equals(comForm.getApply_order_id())){
					%>
							...
							<li class="line">line</li>
							<li><a class="edit" href="<%=path%>/companyAction.do?method=toUserOnEdit&employee_id=<%=user.getEmployee_id() %>" target="navTab"><span>修改</span></a></li>
							<li class="line">line</li>
							<li><a class="delete" href="<%=path%>/companyAction.do?method=delUser&employee_id=<%=user.getEmployee_id() %>" target="ajaxTodo"  title="确定要删除吗?"><span>删除</span></a></li>
							<li class="line">line</li>
					<%
				}
				%>
