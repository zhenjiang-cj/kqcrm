	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function(){
	     	...
	     	var url = '<%=path%>/companyAction.do?method=viewUserResume&employee_id=<%=comForm.getEmployee_id() %>';
	     	 $("#jbsxBoxle").loadUrl(url,{ data: {}, dialogId: '', callback: null });
				...
				<div class="pageContent sortDrag" selector="h1"  >
					...
					<div id="navTab0" class="panel">
						<div class="pageContent">
							  <form class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDones)" action="<%=path%>/companyAction.do?method=doUserLegalEdit" method="post" name="userForm">
							...
							<!-- 简历管理 -->
											<div id="jbsxBoxle" class="unitBox" style="margin-left:10px;">
											</div>
						</div>
					</div>
