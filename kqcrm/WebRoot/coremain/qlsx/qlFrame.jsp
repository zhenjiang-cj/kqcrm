...
<body scroll="no">
	<div id="layout">
		...
		<div id="leftside">
			<div id="sidebar_s">
				<div class="collapse" style="height:648px">
			...
			<div id="sidebar" style="height:648px">
				...
				<div class="accordion" fillSpace="sidebar">
					<div class="accordionHeader">
						<h2><span>Folder</span>权力事项后台管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">							
							<li><a href="<%=path%>/qlsxBack.do?method=queryQlInfoList" target="navTab" rel="qusllist">权力事项列表</a></li>
							<li><a href="<%=path%>/coremain/qlsx/qlInfoAddBack.jsp" target="navTab" rel="addqlsx">新增权力事项</a></li>
							<!-- <li><a href="<%=request.getContextPath() %>/coremain/qlsx/qlInfoAddBack1.jsp" target="navTab" rel="addqlsx">新增权力事项1</a></li> -->
						</ul>
					</div>					
				</div>
			</div>
