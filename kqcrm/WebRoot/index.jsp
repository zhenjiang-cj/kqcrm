...
<body scroll="no">
	<div id="layout">
		<div id="header">
			...
			<div id="navMenu">
				<ul>
					<li class="selected"><a href="<%=path%>/dwz/sidebar_2.html"><span>订单管理</span></a></li>
					<li ><a href="<%=path%>/coremain/portal/user/frame.jsp"><span>系统管理</span></a></li>
					<li><a href="<%=path%>/dwz/sidebar_1.html"><span>产品管理</span></a></li>
					<li><a href="<%=path%>/dwz/sidebar_2.html"><span>会员管理</span></a></li>
					<li><a href="<%=path%>/dwz/sidebar_1.html"><span>服务管理</span></a></li>
					<li><a href="<%=path%>/dwz/sidebar_2.html"><span>系统设置</span></a></li>
				</ul>
			</div>
		</div>
