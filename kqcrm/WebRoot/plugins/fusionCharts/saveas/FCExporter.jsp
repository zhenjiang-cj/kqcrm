...
<%@ page import="com.nl.util.chart.fusion.exporter.FusionChartsExportHelper" %>
<%@ page import="com.nl.util.chart.fusion.exporter.ErrorHandler" %>
<%@ page import="com.nl.util.chart.fusion.exporter.beans.ExportBean" %>
...
<%
    ...
    if (localExportBean.getMetadata().getWidth() == -1 || localExportBean.getMetadata().getHeight() == -1 || localExportBean.getMetadata().getWidth() == 0 ||
...
<jsp:useBean id="exportBean" scope="request" class="com.nl.util.chart.fusion.exporter.beans.ExportBean">
...
<%
 /*   ExportBean exportBean = new ExportBean();
    exportBean.setMetadata(localExportBean.getMetadata());
    exportBean.setStream(localExportBean.getStream());
    exportBean.setExportParameters(localExportBean.getExportParameters());
    request.setAttribute("exportBean", exportBean);*/

//    System.out.println("exporterFilePath = " + exporterFilePath);
//    File exporter = new File(WEB_ROOT_PATH + pathSeparator + exporterFilePath);
//    System.out.println("exporter.getAbsolute = " + exporter.getAbsolutePath());
//    if (exporter.exists()) {
%>
<%--RequestDispatcher rd = request.getRequestDispatcher(exporterFilePath);--%>
