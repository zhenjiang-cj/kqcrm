<%@page import="java.io.OutputStream" %><%@page import="java.io.File" %><%@page import="java.io.FileOutputStream" %><%@page import="java.io.IOException" %><%@ page import="com.nl.util.chart.fusion.exporter.FusionChartsExportHelper" %><%@ page import="com.nl.util.chart.fusion.exporter.ErrorHandler" %><%@ page import="com.nl.util.chart.fusion.exporter.beans.ChartMetadata" %><%@ page import="com.nl.util.chart.fusion.exporter.generators.PDFGenerator" %><jsp:useBean id="exportBean" scope="request" class="com.nl.util.chart.fusion.exporter.beans.ExportBean"/><% String action= (String)exportBean.getExportParameterValue("exportaction");
